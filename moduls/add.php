...
$id=mysqli_num_rows($pre_id)+1;
 ...
 <div class="hero-text container"><h1>Отзыв не добавлен :(</h1><h3>Произошла ошибка</h3><a class="btn btn-outline-light" href="../index.php" role="button">На главную</a>';
 else // если все прошло нормально – выводим сообщение
 echo ' <div class="hero hero-success" id="hero">
 <div class="hero-text container"><h1>Отзыв добавлен!</h1><a class="btn btn-outline-light" href="../index.php" role="button">На главную</a>';
 }
?> 
        </div>
   </div>
